    ...
    CommandLineRunner initDataBase(DonacionRepository repo){
        return args -> {
            if (repo.count() > 0) {
                ...
                Donacion don1 = new Donacion(null, 10000, new Date(), "Transferencia", 1);
                
                Donacion don2 = new Donacion(null, 25000, new Date(), "Tarjeta", 2);

                Donacion don3 = new Donacion(null, 5000, new Date(), "Efectivo", 3);
